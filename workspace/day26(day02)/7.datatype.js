...
//false, 0 , -0, 0n(BigInt 형식의 0), ""(빈문자열), nullm undefined, NaN
...
//Object 객체 : 키-값 쌍의 집합
let person = {name: `신동석`, age:20, isStudent : true};
console.log(person); // name: '신동석', age: 20, isStudent: true 
console.log(person.age); //20 객체.key로 해당 value에 접근할 수 있다
